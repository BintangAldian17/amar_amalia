  ...
  return (
    <section className="h-screen w-full flex flex-col items-start lg:pb-32 md:pb-20 pb-10 gap-10 lg:text-4xl md:text-2xl text-xl relative overflow-hidden text-white">
      ...
      <div className="flex flex-col items-start justify-end z-10  w-full h-full lg:pl-20 md:pl-16 pl-12">
        ...
        <h1 className="text-[#d19b22] flex flex-col items-start lg:gap-6 md:gap-4 gap-2 text-4xl md:text-[96px] font-playwrite-us-modern drop-shadow-md">
          {/* AMAR */}
          <span className="flex items-end">Amar</span>

          {/* Simbol & */}
          <span
            className={`italic lg:text-5xl md:text-4xl text-3xl text-[#d19b22] lg:translate-y-3 w-full text-center -translate-x-8`}
          >
            &
          </span>

          {/* AMALIA */}
          <span className="flex items-end">Amalia</span>
        </h1>

        {/* Tanggal Acara */}
        <p className="text-lg md:text-4xl font-light lg:mt-5 mt-2">
          07 . 02 . 26
        </p>
      </div>
    </section>
